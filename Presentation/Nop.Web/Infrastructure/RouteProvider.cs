...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("LoginFromPopup", "loginfrompopup/",
               new { controller = "Customer", action = "LoginFromPopup" },
               new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("AjaxLoginCheck", "customer/ajaxlogincheck/",
               new { controller = "Customer", action = "AjaxLoginCheck" },
               new[] { "Nop.Web.Controllers" });
