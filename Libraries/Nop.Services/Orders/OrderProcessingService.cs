    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual PlaceOrderContainter PreparePlaceOrderDetails(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            if (details.Cart.RequiresShipping())
            {
                ...
                {
                    if (processPaymentRequest.PaymentMethodSystemName == "Payments.CashOnDelivery") details.ShippingMethodName = "Cash On Delivery";
                    else details.ShippingMethodName = shippingOption.Name;
        ...
        /// </summary>
        /// <param name="order">Order</param>
        public virtual void AwardRewardPoints(Order order)
        {
        ...
        public virtual PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            try
            {
                ...
                {
                    /*if ((processPaymentRequest.PaymentMethodSystemName.ToLower() == "payments.razor" && processPaymentResult.NewPaymentStatus == PaymentStatus.Pending))
                    {
